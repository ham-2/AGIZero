...
{ S(-34 ,  -38), S(-23 ,  -10), S(-10 ,    0), S(  0 ,    2) },
{ S(-31 ,  -22), S( -5 ,    1), S(  6 ,    6), S( 12 ,   15) },
{ S(-32 ,  -23), S( -5 ,   -4), S( 12 ,    3), S( 29 ,    3) },
{ S(-26 ,  -24), S( -8 ,    1), S( 14 ,    3), S( 28 ,    3) },
...
{ S(-14 ,   -7), S( 15 ,   -6), S(12 ,   -5), S(-17 ,   -3) }
    ...
    { // Queen
{ S(-30 ,  -21), S(-20 ,  -29), S(-15 ,   -8), S( -8 ,   -5) },
{ S(-18 ,   -7), S(-10 ,  -11), S( -5 ,   -6), S( -6 ,   -5) },
{ S(-23 ,   -1), S(-15 ,  -12), S(-20 ,   -4), S(-30 ,    1) },
...
{ // Pawn
    { },
{ S(-13,  6), S( -8, -2), S(-20,  0), S(13, -6), S(16,  0), S( 18,   0), S(11,  0), S( 5, -12) },
{ S(-15, -2), S( -2,  0), S(  8, 11), S( 8,  3), S( 8, -1), S( -7, -10), S(-9, -1), S(-2,  -1) },
{ S(-16,  3), S( -6,  1), S( 12, -5), S(15, -6), S(22, -3), S(  7,   1), S(-9, -4), S(-6,   2) },
{ S(-11,  4), S( -5, -1), S(  8, -1), S(18,  2), S(24, -2), S(  8,  -3), S(-5,  0), S( 0,   3) },
{ S( -4,  0), S(  0, -3), S(  5,  3), S(17,  4), S(18,  6), S(  8,   6), S(-3,  5), S( 3,   0) },
{ S( -1,  3), S(  4,  5), S(  6, -7), S(16,  0), S(17,  0), S( 11,  -5), S(-2,  8), S( 6,   4) }
};

constexpr Score Activity[5] = { S(5, 2), S(8, 0), S(4, 3), S(0, 3), S(17, 0) };

...
{ S(-16,  3), S( -6,  1), S( 12, -5), S(15, -6), S(22, -3), S(  2,   1), S(-9, -4), S(-6,   2) },
{ S(-11,  4), S( -5, -1), S(  1, -1), S(18,  2), S(24, -2), S(  3,  -3), S(-5,  0), S( 0,   3) },
{ S( -4,  0), S(  0, -3), S(  5,  3), S(17,  4), S(18,  6), S(  8,   6), S(-3,  5), S( 3,   0) },
{ S( -1,  3), S(  4,  5), S(  6, -7), S(16,  0), S(17,  0), S( 11,  -5), S(-2,  8), S( 6,   4) }
    };

    constexpr Score Activity[5] = { S(12,  2), S(8,  0), S(4,  3), S(0, 3), S(15,  0) };
